...
public class GameActivity4x4 extends BaseActivity {
    ...
    private void setListener() {
        ...
        RestatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (playable) {
                    Play();
                    restartGame();
                    Animatoo.animateZoom(GameActivity4x4.this);
                } else {
                    restartGame();
                }
            }
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.resultat_btn: {
                        Intent intent = new Intent(GameActivity4x4.this, ResultEndActivity.class);
                        Animatoo.animateZoom(GameActivity4x4.this);
        ...
        HomeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.home_btn1: {
                        AlertDialog.Builder builder = new AlertDialog.Builder(GameActivity4x4.this);
                        builder.setTitle("Home...")
                                .setMessage("Do you want to move to home page?\nIf you click YES,the game will end!");
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent = new Intent(GameActivity4x4.this, MainActivity.class);
                                startActivity(intent);
                                Animatoo.animateZoom(GameActivity4x4.this);
                                restartGame();
                                finish();
    ...
    private void showAlert() {
        ...
        builder.setPositiveButton("Show result", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                finish();
                Intent intent = new Intent(GameActivity4x4.this, ResultActivity.class);
                Animatoo.animateZoom(GameActivity4x4.this);
